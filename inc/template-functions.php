 ...
 * @return array
 */
if ( ! function_exists( 'goldencat_body_classes' ) ) {
 ...
 */
if ( ! function_exists( 'goldencat_continue_reading_text' ) ) {
 ...
 */
if ( ! function_exists( 'goldencat_continue_reading_link_excerpt' ) ) {
 ...
 */
if ( ! function_exists( 'goldencat_continue_reading_link' ) ) {
 ...
 * Excerpt Length
 */
if ( ! function_exists( 'goldencat_filter_excerpt_length' ) ) {
 ...
 */
if ( ! function_exists( 'goldencat_limit_type_post' ) ) {
